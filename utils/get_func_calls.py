...
def call_function_function_calling(function_details):
    function_name = function_details["function_name"]
    arguments = function_details["arguments"]
    
    # Check if the function exists and call it dynamically
...
# Example usage
#function_details = {"function_name": "send_status_to_managers", "arguments": {"phone_number": "9963012930"}}
#response = call_function(function_details)
#print(response)



def create_function_call_output(callid, message: str):
    response = {
...
# Example usage
#horoscope_message = "You will soon meet a new friend."
#call_id = "call_sHlR7iaFwQ2YQOqm"
#ret= create_function_call_output(call_id, horoscope_message)
#print(ret)
